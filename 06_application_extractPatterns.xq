...
for sliding window $w in $corpus//phrase/mot
 start $a at $n 
   ...
   and 
   not($a/preceding-sibling::*[1]/@posMorphalou contains text {'verb','pronoun','P'})
 only end $b at $m 
   when ($b/@posMorphalou,$b/@pos) contains text {"commonNoun","pronoun","P"} 
   and 
   not(($b/@posMorphalou,$b/@pos) contains text {"verb"})
